<section id="expertise" class="bg-light py-5">
            <div class="container">
                <div class="row mt-5">
                    <h2>Mon expertise</h2>
                ...
                <div class="row mt-5 gy-4">
                    <div class="col-12 col-md-7">
                        ...
                        <div class="p-3 mb-3 bg-white">
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    <div class="progress">
                                        <div class="progress-bar w-75" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" data-bs-toggle="tooltip" title="75%"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 offset-md-1 col-md-4">
                        <img src="img/code.jpg" alt="Code PHP" width="100%">
                    </div>
                </div>
                <div class="row mt-5 gy-4">
                        ...
                        <!--------fin pb-------->
                         ...
                         <div class="p-3 mb-3 bg-white">
                            <div class="row align-items-center">
                                <div class="col-5 col-sm-4 col-md-3 co-xl-2">
                                    <div class="d-flex align-items-center">
                                        <i class="fa fa-video fa-2x me-3 text-primary"></i>
