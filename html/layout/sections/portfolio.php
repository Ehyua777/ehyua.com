                            ...
                            <div class="card-body">
                                ...
                                <div class="offcanvas offcanvas-start h-100" tabindex="-1" id="infoProjet1" aria-labelledby="titleProject1">
                                    <div class="offcanvas-header">
                                      <h5 class="offcanvas-title" id="titleProject1">Projet 1</h5>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Card title</h5>
                                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                <a class="btn btn-primary" data-bs-toggle="offcanvas" data-bs-target="#infoProjet3">Go somewhere</a>
                                <!-------------------CANVAS START---------------->
                                <div class="offcanvas offcanvas-start h-100" tabindex="-1" id="infoProjet3" aria-labelledby="titleProject1">
                                    <div class="offcanvas-header">
                                      <h5 class="offcanvas-title" id="titleProject1">Projet 3</h5>
                                      <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                                    </div>
                                    <div class="offcanvas-body">
                                        <!------carousel 1 start-->
                                        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                                            ...
                                            <div class="carousel-inner">
                                              <div class="carousel-item active">
                                                <img src="https://picsum.photos/1920/1080?random=7" class="d-block w-100" alt="...">
                                                <div class="carousel-caption d-none d-md-block">
                                                  <h5>First slide label</h5>
                                                  <p>Some representative placeholder content for the first slide.</p>
                                                </div>
                                              ...
                                              <div class="carousel-item">
                                                <img src="https://picsum.photos/1920/1080?random=8" class="d-block w-100" alt="...">
                                                <div class="carousel-caption d-none d-md-block">
                                                  <h5>Second slide label</h5>
                                                  <p>Some representative placeholder content for the second slide.</p>
                                                </div>
                                              ...
                                              <div class="carousel-item">
                                                <img src="https://picsum.photos/1920/1080?random=9" class="d-block w-100" alt="...">
                                                <div class="carousel-caption d-none d-md-block">
                                                  <h5>Third slide label</h5>
                                                  <p>Some representative placeholder content for the third slide.</p>
                                                </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Card title</h5>
                                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                <a class="btn btn-primary" data-bs-toggle="offcanvas" data-bs-target="#infoProjet4">Go somewhere</a>
                                <!-------------------CANVAS START---------------->
                                <div class="offcanvas offcanvas-start h-100" tabindex="-1" id="infoProjet4" aria-labelledby="titleProject1">
                                    <div class="offcanvas-header">
                                      <h5 class="offcanvas-title" id="titleProject1">Projet 4</h5>
                                      <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                                    </div>
                                    <div class="offcanvas-body">
                                        <!------carousel 1 start-->
